...
namespace Gamekit3D
{
    ...
    public class SceneController : MonoBehaviour
    {
        ...
        protected PlayerInputController playerInputControllerController;
        ...
        void Awake()
        {
            ...
            playerInputControllerController = FindObjectOfType<PlayerInputController>();
        ...
        protected IEnumerator Transition(string newSceneName, SceneTransitionDestination.DestinationTag destinationTag, TransitionPoint.TransitionType transitionType = TransitionPoint.TransitionType.DifferentZone)
        {
            ...
            if (playerInputControllerController == null)
                playerInputControllerController = FindObjectOfType<PlayerInputController>();
            if (playerInputControllerController) playerInputControllerController.ReleaseControl();
            ...
            if (playerInputControllerController)
                playerInputControllerController.GainControl();
