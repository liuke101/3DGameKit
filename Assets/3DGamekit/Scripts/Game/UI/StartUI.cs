...
namespace Gamekit3D
{
    public class StartUI : MonoBehaviour
    {
        ...
        void Update()
        {
            if (PlayerInputController.Instance != null && PlayerInputController.Instance.Pause)
            {
                SwitchPauseState();
            }
        }
        ...
        protected void SwitchPauseState()
        {
            ...
            if (m_InPause)
                PlayerInputController.Instance.GainControl();
            else
                PlayerInputController.Instance.ReleaseControl();
