...
namespace Gamekit3D
{
    ...
    public class PlayerController : MonoBehaviour, IMessageReceiver
    {
        ...
        protected PlayerInputController inputControllerController;                 // Reference used to determine how Ellen should move.
        ...
        {
            get { return !Mathf.Approximately(inputControllerController.MoveInput.sqrMagnitude, 0f); }
        }
        ...
        void Awake()
        {
            inputControllerController = GetComponent<PlayerInputController>();
        ...
        void FixedUpdate()
        {
            ...
            if (inputControllerController.Attack && canAttack)
        ...
        void UpdateInputBlocking()
        {
            ...
            inputControllerController.playerControllerInputBlocked = inputBlocked;
        }
        ...
        void CalculateForwardMovement()
        {
            ...
            Vector2 moveInput = inputControllerController.MoveInput;
        ...
        void CalculateVerticalMovement()
        {
            ...
            if (!inputControllerController.JumpInput && m_IsGrounded)
                m_ReadyToJump = true;
            ...
            if (m_IsGrounded)
            {
                ...
                if (inputControllerController.JumpInput && m_ReadyToJump && !m_InCombo)
                {
            ...
            else
            {
                ...
                if (!inputControllerController.JumpInput && m_VerticalSpeed > 0.0f)
                {
        ...
        void UpdateOrientation()
        {
            ...
            Vector3 localInput = new Vector3(inputControllerController.MoveInput.x, 0f, inputControllerController.MoveInput.y);
        ...
        void TimeoutToIdle()
        {
            bool inputDetected = IsMoveInput || inputControllerController.Attack || inputControllerController.JumpInput;
